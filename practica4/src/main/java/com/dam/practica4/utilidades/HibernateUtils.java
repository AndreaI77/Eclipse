...
public class HibernateUtils {
	...
	// Mediante nativeQuery devuelve una lista de categorías que contienen en su
	// descripción el texto obtenido como parámetro.
	@SuppressWarnings({ "deprecation", "unchecked" })
	public static List<Categories> buscarTextoCategories(String text) {
		return session.createNativeQuery("SELECT * FROM categories WHERE lower(category) like :cat")
				.addEntity(Categories.class).setParameter("cat", text).list();
	}

	// Mediante nativeQuery devuelve una lista con todas las categorías
	@SuppressWarnings({ "deprecation", "unchecked" })
	public static List<Categories> devolverCategories() {
		return session.createNativeQuery("SELECT * FROM categories").addEntity(Categories.class).list();
	}

	// Usando NamedQuery devuelve una lista con los lenguajes que contienen el texto
	// pasado como parámetro
	@SuppressWarnings({ "deprecation", "unchecked" })
	public static List<Language> buscarTextoLanguage(String cadena) {
		Query<Language> query = session.createNamedQuery("Query_get_text");
		query.setParameter("text", cadena);
		return query.list();
	}

	// Usando NamedQuery devuelve una lista con todos los lenguajes
	@SuppressWarnings({ "deprecation", "unchecked" })
	public static List<Language> devolverLenguajes() {
		return session.createNamedQuery("Query_get_lenguajes").list();
	}
	...
	// Los siguientes métodos no los he usado, pero los mantengo para tener ejemplos.
